  ...
  return (
    <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-[#0A0B0D]">
      ...
      <div className="relative max-w-7xl mx-auto px-6 z-10 text-center flex flex-col items-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-500/5 border border-teal-500/20 rounded-full text-teal-400 text-[10px] uppercase tracking-[0.3em] font-black mb-8 backdrop-blur-sm">
          <span className="w-1.5 h-1.5 bg-teal-400 rounded-full animate-pulse shadow-[0_0_10px_#2dd4bf]" />
          Valódi Üzleti Automatizáció
        </div>

        <h1 className="text-6xl md:text-8xl lg:text-[6.5rem] font-bold tracking-tighter leading-[1.05] md:leading-[0.9] mb-8 text-white">
        ...
        <p className="text-lg md:text-2xl text-gray-400 max-w-4xl text-center leading-relaxed mb-12 font-medium">
