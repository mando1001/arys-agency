      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="relative p-12 md:p-24 rounded-[48px] bg-[#0D0F14] border border-white/5 overflow-hidden text-center">
          ...
          <div className="max-w-3xl mx-auto space-y-10 relative z-10">
            <div className="inline-flex items-center gap-3 px-4 py-2 bg-teal-500/5 border border-teal-500/10 rounded-full text-teal-400 text-[10px] font-black uppercase tracking-[0.3em]">
