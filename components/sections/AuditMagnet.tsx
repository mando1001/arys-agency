  ...
  return (
    <section id="audit" className="py-32 relative overflow-hidden bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="relative p-12 md:p-24 rounded-[4rem] bg-white border-2 border-slate-200 overflow-hidden text-center shadow-2xl shadow-primary/5">
          ...
          <div className="max-w-4xl mx-auto space-y-12 relative z-10">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-primary text-white rounded-full text-[10px] font-black uppercase tracking-[0.4em] shadow-lg shadow-primary/20">
            ...
            <div className="flex flex-col items-center gap-10">
              <AuditButton />
              <div className="flex flex-wrap justify-center items-center gap-10 text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">
