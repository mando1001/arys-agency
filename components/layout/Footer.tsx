...
export const Footer = () => (
  <footer className="relative bg-[#042F2E] border-t border-teal-500/10 pt-20 pb-10 overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        <div className="col-span-1 md:col-span-2 space-y-8">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
              <div className="w-4 h-4 bg-[#042F2E] rounded-sm rotate-45" />
            </div>
            <span className="text-xl font-black tracking-tighter text-white">ARYS</span>
          </div>
          <p className="text-teal-100/60 max-w-sm leading-relaxed text-sm">
          ...
          <div className="flex flex-col gap-4">
            <a href="mailto:hello@arys.hu" className="text-sm text-teal-100/60 hover:text-teal-400 transition-colors flex items-center gap-2">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-4 text-sm text-teal-100/60">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-teal-500/10 gap-6">
        <p className="text-[10px] text-teal-100/30 uppercase tracking-widest font-bold">
          &copy; 2026 ARYS — ALL RIGHTS RESERVED
        </p>
        <div className="flex gap-8 text-[10px] text-teal-100/30 uppercase tracking-widest font-bold">
